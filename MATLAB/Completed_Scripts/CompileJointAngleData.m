...
% Save the variables that we will likely need later
save Avg_Joint_Angles Avg_Joint_Angles_Walking Avg_Joint_Angles_Descend ...
    Avg_Joint_Angles_Ascend Avg_Joint_Angles_ToeWalking ...
    Avg_Joint_Angles_HeelWalking 
